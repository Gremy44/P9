...
from .forms import DeleteReviewForm, DeleteTicketForm, TicketForm, PhotoForm, ReviewForm
...
def get_users_viewable_reviews(user):
    ...
    for abonnement in abonnements:
        review_abonnes = Review.objects.filter(author = abonnement.followed).exclude(ticket__author=user)
        review_abonnes = review_abonnes.annotate(content_type=Value('REVIEW', CharField()))
...
def get_users_viewable_tickets(user):
    ...
    for abonnement in abonnements:
        ...
        ticket_abonnes = ticket_abonnes.annotate(content_type=Value('TICKET', CharField()))
