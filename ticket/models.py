...
class Ticket(models.Model):
    ticket_title = models.CharField(max_length=128, verbose_name='Titre du livre')
...
class Review(models.Model):
    author = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)
    review_title = models.CharField(max_length=128, verbose_name='Titre de la critique')
    comment = models.TextField(max_length=5000, verbose_name='Votre commentaire')
    rate = models.PositiveSmallIntegerField(choices=RATE_CHOICES,verbose_name='Note', default=3)
